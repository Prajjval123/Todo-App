...
import { saveTodosToLocalStorage } from "../localstorage/localStorage";
...
const TodoItem = ({ todo, index }) => {
  ...
  const handleDelete = () => {
    ...
    saveTodosToLocalStorage(removeTodo(index));
  };

  const handleMarkCompleted = () => {
    dispatch(markCompleted(index));
    saveTodosToLocalStorage(markCompleted(index));
  };

  const handleMarkInComplete = () => {
    dispatch(markIncomplete(index));
    saveTodosToLocalStorage(dispatch(markIncomplete(index)));
  };
  return (
